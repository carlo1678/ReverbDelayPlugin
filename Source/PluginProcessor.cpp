...
void ReverbDelayPluginAudioProcessor::loadTelephoneNoise()
{
    ...
    int dataSize = 0;
    const char* sourceData = BinaryData::getNamedResource("telephone_noise_wav", dataSize);
...
void ReverbDelayPluginAudioProcessor::loadUnderwaterSound()
{
    ...
    int dataSize = 0;
    const char* sourceData = BinaryData::getNamedResource("underwater_sound_effect_wav", dataSize);
